...
class FakeBucket:
    ...
    def upload(self, *, path, file, file_options):
        ...
        assert json.load(file)["report_version"] == "analysis-report-v2.1-beta.1"
...
def test_database_summary_is_small_and_has_no_frames(
    ...
    assert summary["report_version"] == "analysis-report-v2.1-beta.1"
...
def test_storage_path_and_upload_are_deterministic(tmp_path):
    ...
    local_path.write_text('{"report_version":"analysis-report-v2.1-beta.1"}', encoding="utf-8")
    bucket = FakeBucket()
