...
const stages = [
  ...
  { id: "beta-release", title: "Wersja testowa", description: "Dwa niezależne tryby: analiza filmu oraz Photo Scene Builder w v0.21.0-beta.1.", status: "completed", group: "infrastructure" },
