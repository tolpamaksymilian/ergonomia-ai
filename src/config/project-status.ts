...
const stages = [
  ...
  { id: "pose-v3", title: "Pose Pipeline V4 beta", description: "Wersjonowany pipeline analizy sylwetki i jakości.", status: "completed", group: "vision" },
  ...
  { id: "beta-release", title: "Wersja testowa", description: "Evidence-aware przepływ v0.6.0-beta.1 gotowy do testów.", status: "completed", group: "infrastructure" },
...
export const projectStatus = {
  ...
  versions: {
    application: "v0.6.0-beta.1",
    posePipeline: "pose-v4.0-beta.1",
