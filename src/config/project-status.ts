...
const stages = [
  ...
  { id: "charts", title: "Wykresy", description: "Zmiany metryk i ekspozycji w czasie.", status: "in_progress", group: "reporting" },
  { id: "key-frames", title: "Obrazy kluczowych klatek", description: "Generowanie obrazów reprezentatywnych momentów analizy.", status: "in_progress", group: "reporting" },
  { id: "final-report", title: "Raport końcowy", description: "Zwięzłe podsumowanie dla specjalisty.", status: "in_progress", group: "reporting" },
