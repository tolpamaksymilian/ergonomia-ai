...
const stages = [
  ...
  { id: "beta-release", title: "Wersja testowa", description: "Dwa niezależne tryby analizy i dopracowany panel organizacyjny dark-only w v0.28.0-beta.1.", status: "completed", group: "infrastructure" },
