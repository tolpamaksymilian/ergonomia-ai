...
const stages = [
  ...
  { id: "report-engine", title: "Report Engine V2", description: "Krótkie, deterministyczne wnioski powiązane z dowodami.", status: "completed", group: "reporting" },
  ...
  { id: "beta-release", title: "Wersja testowa", description: "Robust multimodal pipeline v0.7.0-beta.1 gotowy do testów.", status: "completed", group: "infrastructure" },
...
export const projectStatus = {
  ...
  versions: {
    application: "v0.7.0-beta.1",
    posePipeline: "pose-v5.0-beta.1",
    ergonomicsMetricsEngine: "v1.0",
    riskEngine: "v1.0",
    reportEngine: "analysis-report-v2.0-beta.1",
  ...
  publicPlans: [
    ...
    { id: "methods-context", title: "Kontekst manualny metod", description: "Jawne podawanie obciążenia, coupling i parametrów zadania." },
