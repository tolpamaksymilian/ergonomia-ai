...
const stages = [
  ...
  { id: "beta-release", title: "Wersja testowa", description: "Jasny i ciemny motyw oraz odświeżony design system w v0.11.0-beta.1.", status: "completed", group: "infrastructure" },
