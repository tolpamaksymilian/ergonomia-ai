...
const stages = [
  ...
  { id: "beta-release", title: "Wersja testowa", description: "Dwa niezależne tryby: analiza filmu oraz Photo Scene Builder w v0.15.0-beta.1.", status: "completed", group: "infrastructure" },
...
export const projectStatus = {
  ...
  versions: {
    application: "v0.15.0-beta.1",
    sceneBuilder: "photo-scene-builder-v0.4-beta.1",
