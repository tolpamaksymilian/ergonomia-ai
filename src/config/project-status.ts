...
const stages = [
  ...
  { id: "beta-release", title: "Wersja testowa", description: "Dwa niezależne tryby analizy i nowy panel organizacyjny w v0.27.0-beta.1.", status: "completed", group: "infrastructure" },
