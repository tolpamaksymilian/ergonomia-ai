...
const stages = [
  ...
  { id: "photo-scene-builder", title: "Projektowanie stanowiska ze zdjęcia — Beta", description: "Scene World Model, Calibration V3, semantyczne pomiary, prowadzona kalibracja i wiele modeli operatorów.", status: "in_progress", group: "scene_builder" },
  ...
  { id: "beta-release", title: "Wersja testowa", description: "Dwa niezależne tryby: analiza filmu oraz Photo Scene Builder w v0.17.0-beta.1.", status: "completed", group: "infrastructure" },
...
export const projectStatus = {
  ...
  versions: {
    application: "v0.17.0-beta.1",
    sceneBuilder: "photo-scene-builder-v0.6-beta.1",
