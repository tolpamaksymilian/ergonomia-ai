...
const stages = [
  ...
  { id: "ejms-company", title: "EJMS zakładowy", description: "Evidence-aware sekcja I oraz częściowa sekcja transportowa.", status: "completed", group: "risk" },
...
export const projectStatus = {
  ...
  fullPipeline: [
    ...
    { id: "pipeline-company-methods", title: "Metody zakładowe", description: "OWAS, EJMS i dane kontekstowe z prywatnym zapisem.", status: "completed", group: "risk" },
