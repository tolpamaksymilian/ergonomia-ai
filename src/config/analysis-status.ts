...
const stageDefinitions = {
  ...
  "ready-for-ai": status("Film gotowy do analizy pozy", "Gotowe do Pose", "Nagranie czeka na Pose Pipeline V6.", 20, "queued", true),
  "pose-claimed": status("Analiza pozy w toku", "Pose Pipeline", "Pose Pipeline V6 przejął nagranie.", 20, "active", true),
  ...
  "downloading-for-pose-v6": status("Analiza pozy w toku", "Pose Pipeline V6", "Pobieramy film do analizy pozy.", 21, "active", true),
  ...
  "pose-inference-active-segment-v6": status("Analiza pozy w toku", "Pose Pipeline V6", "Analizujemy aktywny fragment z ciągłością czasową ciała i dłoni.", 30, "active", true),
  ...
  "uploading-pose-results-v6": status("Zapisywanie wyników pozy", "Pose Pipeline V6", "Przesyłamy film, dane pozy i diagnostykę V6 do prywatnego Storage.", 91, "active", true),
  ...
  "saving-pose-results-v6": status("Kończenie analizy pozy", "Pose Pipeline V6", "Kończymy zapis wersjonowanych wyników Pose Pipeline V6.", 97, "active", true),
