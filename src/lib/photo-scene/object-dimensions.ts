...
export const OBJECT_DIMENSIONS: Record<SceneObjectType, DimensionDefinition[]> = {
  ...
  CHAIR: [{ key: "seatHeightCm", label: "Wysokość siedziska", priority: "CRITICAL" }, { key: "seatWidthCm", label: "Szerokość siedziska", priority: "RECOMMENDED" }, { key: "seatDepthCm", label: "Głębokość siedziska", priority: "RECOMMENDED" }, { key: "backrestHeightCm", label: "Wysokość oparcia", priority: "RECOMMENDED" }],
  ...
  MONITOR: [{ key: "screenCenterHeightCm", label: "Wysokość środka ekranu", priority: "CRITICAL" }, { key: "widthCm", label: "Szerokość ekranu", priority: "OPTIONAL" }, { key: "screenHeightCm", label: "Wysokość ekranu", priority: "OPTIONAL" }, { key: "userDistanceCm", label: "Odległość od użytkownika", priority: "RECOMMENDED" }],
